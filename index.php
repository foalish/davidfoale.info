                                    ...
                                    <div id="projects" class="projet-items clearfix">
                                        ...
                                        <div class="pop-up-box" id="portfolio-2">
                                            ...
                                            <div class="popup-content">
                                                ...
                                                <p>
                                                    The obvious one is sell into any strength of GBP/USD 1:33-1:34 if it gets there, down to 1:25
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-3">
                                            ...
                                            <div class="popup-content">
                                               <h3>15 SECRETS from a PROFESSIONAL TRADER</h3>
                                                <p>
                                                    What professional traders know when they make trades, that you may not be aware off. It's the seemingly small details that often make the winning difference between profitable traders and the majority.
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
    ...
    <div id="service" class="service-page container-fluid page">
        <div class="row">
            ...
            <div class="content-container col-md-9 col-sm-12">
                ...
                <div class="clearfix">
                    <h2 class="small-heading">Six MINI BLOGS</h2>
                    <div class="row">
                                    ...
                                    <div class="faq-desc-item">
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <h5>Article 50</h5>
                                                   <p>Its all about WHEN and IF. BREXIT is going to happen, so at some point the UK Parliament has to trigger it. But WHEN. Teresa May is ruling out an early election. Also MP's so far have yet to vote on Brexit itself, Article 50, immigration curbs, continued free access to Europe, its all on hold until the Conservative Party elect a new leader.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    ...
                                                    <h5>9 Month View</h5>
                                                     <p>Indexes to begin slow but sustained sell off, back towards post EU Referendum lows. Continued volatility in Sterling but more volatility in the Euro than we have seen so far since the EU Referendum </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    ...
                                                    <h5>Political Predictions</h5>
                                                    <p>End 2017 we will have 4 UK political parties. CONSERVATIVES lead by Teresa May, easing us out of Europe. LABOUR lead by Angela Eagle rebuilding the mess left by Corbyn, a renamed UKIP lead by Andrea Leadsom which will become the 'Brexit Now Party' and the Lib.Dems/ Greens in a new party representing the 'Lets Rejoin Europe' voters. With 'UKIP 2.0' becoming the second largest party. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                   ...
                                                   <p>One week after the EU referendum, I am now short both the FTSE100 and the FTSE250</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <!-- <i class="fa fa-lightbulb-o fa-fw"></i> -->
                                                    <h5>SILVER </h5>
                                                     <p> Huge speculative rise in this metal particularly since the Referendum. Watching closely, no position.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <!-- <i class="fa fa-paint-brush fa-fw"></i> -->
                                                    <h5>Negotiation Skills</h5>
                                                    <p>Renegotiate our relationship with our EU neighbours. Trouble is there is little evidence UK polititians or Gvt bodies can negotiate themselves out of a paper bag. To negotiate successfully you either have to start from a position of strength, or offer something the other party badly wants. Before you do that, the UK has to indentify what those things are.</p>
